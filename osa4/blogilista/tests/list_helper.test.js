...
const dummyBlogsEmpty = []

describe('dummy returns 1', () => {
  test('dummy returns one', () => {
    const result = listHelper.dummy(dummyBlogsEmpty)
...
describe('total likes', () => {
  test('of empty list is zero', () => {
    const result = listHelper.totalLikes(dummyBlogsEmpty)
    expect(result).toBe(0)
  })

  test('when list has only one blog equals the likes of that', () => {
    const result = listHelper.totalLikes(dummyListWithOneBlog)
